 ...
 * <pre>
 *  CustNameHostToXmlTransformer transformer = new CustNameHostToXmlTransformer();
 *  StringWriter writer = new StringWriter();
 *  transformer.transform(hostByteArray, writer);
 * </pre>
 *
 */
public class CustNameHostToXmlTransformer extends AbstractHostToXmlTransformer {

    /**
     * Create a Host to XML transformer using a Host to Java transformer.
     * @throws HostTransformException if transformer cannot be created
     */
    public CustNameHostToXmlTransformer() throws HostTransformException {
        super(new CustNameHostToJavaTransformer());
    }
     ...
     * @throws HostTransformException if transformer cannot be created
     */
    public CustNameHostToXmlTransformer(
            final CobolContext cobolContext) throws HostTransformException {
        super(new CustNameHostToJavaTransformer(cobolContext));
    }
    ...
    public CustNameHostToXmlTransformer(
        ...
        super(new CustNameHostToJavaTransformer(hostCharset));
    }
