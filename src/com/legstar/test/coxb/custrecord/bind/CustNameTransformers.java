...
/**
 * Transformer provider for CustName java data object.
 *
 */
public class CustNameTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public CustNameTransformers() {
        super(new CustNameJavaToHostTransformer(),
                new CustNameHostToJavaTransformer());
    }
     ...
     */
    public CustName toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustName toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustName toJava(final byte[] hostData, final int offset,
