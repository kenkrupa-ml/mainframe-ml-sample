...
/**
 * Transformer provider for CustRecord java data object.
 *
 */
public class CustRecordTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public CustRecordTransformers() {
        super(new CustRecordJavaToHostTransformer(),
                new CustRecordHostToJavaTransformer());
    }
     ...
     */
    public CustRecord toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustRecord toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public CustRecord toJava(final byte[] hostData, final int offset,
